...
<main>
	...
	<%-- 	<c:forEach var="dept_list" items="${deptlist}" > --%>
					<table class="text" >
						...
						<td><a href='${pageContext.request.contextPath}/lecture-evaluation/admin?action=update_form&idx=${list.idx}'>수정 /</a>
							<a href='#' onclick='confirmAndDelete("${list.idx}","${list.lec_name}");'> 삭제</a>
						</td>
						</tr>
						</table>	
					</table>
