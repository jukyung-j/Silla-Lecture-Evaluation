	...
	<main>
		...
		<nav>
			<form
				...
				method="POST">
				<div class="search">
					<input type="text" class="searchbox" placeholder="과목명 또는 교수명 입력"
						name="search_id" />
				</div>
		...
		<table class="text">
			...
			<tr style="text-align: center;">
				<td><a
					href='${pageContext.request.contextPath}/lecture-evaluation/admin?action=update_form&idx=${list.idx}'>수정
						/</a> <a href='#'
					onclick='confirmAndDelete("${list.idx}","${list.lec_name}");'>
						삭제</a></td>
			</tr>
		</table>
		</table>
