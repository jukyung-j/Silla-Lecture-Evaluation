...
.star-input>.input, .star-input>.input>label:hover, .star-input>.input>input:focus+label,
	...
	background: url('../img/grade_img.png');
	no-repeat;
}
...
<body>
	...
	<table class="out">
		<tr>
			<td>${nick}님</td>
			<td><input type="button" class="outbox" value="로그아웃"
				onclick="${pageContext.request.contextPath}/lecture-evaluation/index?action=logout">
			</td>
		</tr>
	</table>
	<fieldset class="register">
		...
		<table class="re">
			<tr>
				<th>Index</th>
				<td><input type="text" class="small" name="idx"
					value="${lecture.idx}" readonly></td>
			</tr>
			<tr>
				<th>강의명</th>
				<td><input type="text" class="small" name="lec_name"
					value="${lec_name}" readonly></td>
			</tr>
			<tr>
				<th>교수명</th>
				<td><input type="text" class="small" name="p_name"
			...
			<tr>
				<th>평가내용</th>
				<td><textarea cols="50" rows="8" class="big" name="content"
