...
<body>
	...
	<fieldset class="register">
      <legend align="center"><h2>강의평가 수정</h2></legend>
      <fotm  action='${pageContext.request.contextPath}/lecture-evaluation/main?action=insert_eval' method="POST">
		<table class="re">
	<tr>
	<th> Index </th>
		<td><input type="text" class="small" name="idx" value="${lecture.idx}" readonly></td>	
	</tr>
	<tr>
	<th> 강의명 </th>
